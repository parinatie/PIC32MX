...
int main(int argc, char** argv)
{
  ...
  // TRISBSET= _TRISB_TRISB0_MASK|_TRISB_TRISB1_MASK; //RB0 and RB1 as switches
    ...
    // Interrupt Config
    INTCONSET=_INTCON_MVEC_MASK | _INTCON_INT4EP_MASK; //Enable Multi vectored interrupt and External Interrupt4 Edge Polarity Control bit- 1 = Rising edge 0 = Falling edge
    IFS0CLR= _IFS0_INT4IF_MASK; // Clear INT4 Flag bit
    IEC0SET=_IEC0_INT4IE_MASK; // INT4 enable
    IPC4bits.INT4IP= 0x04;// Priority
    IPC4bits.INT4IS= 0x03;//Sub priority
...
//ISR
void __ISR(_EXTERNAL_4_VECTOR, IPL7SOFT) EI0_ISR(void)
{
