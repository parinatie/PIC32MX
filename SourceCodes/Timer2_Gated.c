...
int main(int argc, char** argv)
{
  ...
  // TRISBSET= _TRISB_TRISB0_MASK|_TRISB_TRISB1_MASK; //RB0 and RB1 as switches
    ...
    // Timer2 Config
     ...
     T2CONSET=_T2CON_TGATE_MASK; //Gated time accumulation disabled
    ...
    IFS0CLR= _IFS0_T2IF_MASK; // Clear T1 INT Flag bit
    IEC0SET=_IEC0_T2IE_MASK; // Timer1 Interrupt Enable
    IPC2bits.T2IP= 0x05;// Priority
...
//ISR
void __ISR(_TIMER_2_VECTOR, IPL7SOFT) T2_ISR(void)
{
...
//        count=0;
    ...
    // clear the interrupt flag
     IFS0CLR= _IFS0_T2IF_MASK; // Clear T1 INT Flag bit // Clear T1 INT Flag bit
}
//
